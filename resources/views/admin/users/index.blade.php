        ...
        <div class="bg-white border-b border-gray-200 sticky top-0 z-10">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex space-x-8 -mb-px">
                     ...
                     <a href="{{ route('admin.audit.index') }}" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm">
                        Audit Logs
                     </a>
                </div>
            </div>
